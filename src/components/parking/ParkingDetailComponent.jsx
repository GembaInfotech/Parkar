...
const ParkingDetailComponent = ({data, inT, ouT}) => {
  ...
  return (
     <div className='flex  max-h-[85vh] '>
       {/* {show && <div className='fixed top-20 left-0 w-full  text-white px-16 py-4 flex justify-center z-10'><Search   /></div> }
      <button onClick={()=>{setShowMethod()}}>
      <h1  className='mb-4 bg-violet-100 text-sm rounded-2xl w-fit py-2 px-2'><div className='flex'><p>Where you want to go </p><CiSearch className=' bg-yellow-300 rounded-2xl text-xl mx-1 p-1 '/></div> </h1>
      </button> */}
     ...
     <div className=' flex overflow-x-auto w-full  scrollbar-hide'>
      <img src={img} alt="" className='m-2 rounded-2xl h-48 ' />
      <img src={img} alt="" className='m-2 rounded-2xl h-48' />
      <img src={img} alt="" className='m-2 rounded-2xl h-48' />
      <img src={img} alt=""  className='m-2 rounded-2xl h-48'/>
